...
<div class="site-wrap">
    <!-- main content -->
      ...
      <div class="mid">
         ...
         <form action="<?php echo site_url('site/provide_help') ?>" method="post" class="form">
              <ul class="large-5 columns">
							
                  <li><input type="text" name="amt" placeholder="Enter amount(N)" required="required" /></li>
	                       
                 <li><button type="submit" id="submit" name="submit" />Pledge Amount</button></li>
              </ul>
          </form>                  
                  </div>
                  </div>
